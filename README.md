# [SOLVED] How-To-Log-Exception-And-Message-With-Placeholders-With-Slf4
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/how-to-log-exception-and-message-with-placeholders-with-slf4)
>
...
Use ${} placeholders with logger.error() method, e.g. logger.error(
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/how-to-log-exception-and-message-with-placeholders-with-slf4)**
